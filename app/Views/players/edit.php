...
<section class="panel">
    ...
    <form method="post" action="<?= htmlspecialchars($url('players/' . (string) $playerId . '/update'), ENT_QUOTES, 'UTF-8'); ?>" class="form-grid">
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <a class="btn btn-outline-secondary" href="<?= htmlspecialchars($url('players/' . (string) $playerId), ENT_QUOTES, 'UTF-8'); ?>">Cancel</a>
        </div>
    </form>
</section>
